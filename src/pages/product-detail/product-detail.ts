...
export class ProductDetailPage {
    ...
    ionViewDidLoad() {
        this.category_detail = this.navParams.get('category_name');
    ...
    goOnProductSubDetailPage(id){
        this.navCtrl.push(ViewProfilePage,{'id':id})
    }
    ...
    getProductList(id,search)
    {
        ...
        this.service.post_rqst({'filter':this.filter},'app_master/subCategoryList')
        .subscribe( (r) =>
        {
            console.log(r);
            this.loading.dismiss();
            this.prod_list=r['categories'];
            // this.prod_cat=r['categories'];
        });
    }
    presentLoading() 
    {
