...
export class CancelpolicyModalPage {
    ...
    submit()
    {
        ...
        .subscribe( (r) =>
        {
            ...
            {
                this.showAlert("Your account balance low !");
            }

            else if(r['status']=="BALANCELIMITLOW")
            {
                this.showAlert("Your Balance Limit low !");
            }
        });
    }
    showAlert(text) {
    ...
    myNumber()
    {
        ...
        {
            this.data.shipping_address=this.karigar_detail.country;
